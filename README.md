# Домашнее задание к занятию «Системы контроля версий» Дедяхин Игорь
...
3. Создайте авторизационный токен.
...
Создан файл .gitignore, добавлен в комиит, создан каталог terraform и внутри этого каталога — файл .gitignore, в файле README.md опасаны файлы которые будут проигнорированы. Все новые и измененные файлы закоммичены.
...
1-3 Созданы файлы will_be_deleted.txt и will_be_moved.txt, закоммичены. Файл удален с диска и репозитория:

![delete](screenshots/delete.png)

4-5 Переименнован файл will_be_moved.txt в has_been_moved.txt, результат работы закоммичен:
...
Вывод команды git log, 5 коммитов:
...
Результат выполнения команды push, [ссылка на репозиторий](https://github.com/igorsprint-code/devops-netology)
